---
title: "An Almanac for the Age of Chaos"
url: https://www.alephic.com/writing/almanac-for-the-age-of-chaos
published_at: 2026-07-30T12:00:00.000Z
source: www.alephic.com
author: "Tom Critchlow"
guid: https://www.alephic.com/writing/almanac-for-the-age-of-chaos
draft: drafts/three-plane-shift
---

*Marketing’s three-body problem: how to navigate when customers, channels and craft are all changing at once*

![Vintage Michelin Guide](https://images.alephic.com/alephic-com/michelin-image-blue-transparent-1200x630.png)
...
![illustration of the eiffel tower from the 1889 paris world's fair](https://images.alephic.com/alephic-com/eiffel-tower-illustration.png)
...
![graphic depicting the three body problem](https://images.alephic.com/alephic-com/three-body-image.png)
...
[Pew 2026](https://www.pewresearch.org/internet/2026/06/17/americans-and-ai-2026-chatbots-smart-devices-and-views-on-impact/) says about **four in ten U.S. adults use chatbots for information searching**, and **38% of employed adults use them for work tasks**.

AI is not just “information but now with natural language” - it’s about [intelligence too cheap to meter](https://interconnected.org/home/2023/10/06/ubigpt).
...
![A screenshot of chatgpt tom local guide skill](https://images.alephic.com/alephic-com/tom-guide-skill.png)
...
![a photo of a purple starfish](https://images.alephic.com/alephic-com/purple-starfish.png)
...
![a screenshot of ai overview](https://images.alephic.com/alephic-com/ai-overview-anthropic.png)

Like a new predator being introduced into a stable ecosystem, AI search has disrupted the natural balance and order of things. [79% of top news sites block at least one bot used for AI training](https://www.buzzstream.com/blog/publishers-block-ai-study/), while 71% block at least one live search or retrieval bot.

In the old web, almost nobody wanted to block search engines. Now publishers are [putting up walls](https://digiday.com/media/reuters-and-time-adopt-bot-blocking-whitelists-to-rein-in-ai-crawlers/) and making fine-grained decisions about training, retrieval, indexing, citation, and value exchange.
...
But it is not just sloppy, it’s actual spam. [Motivated actors](https://futurism.com/pinterest-ai-slop) are actively spamming these platforms for profit, producing synthetic media at scale to harvest attention, clicks, affiliate revenue, or platform payouts.

This is not a marginal problem. In certain categories, spam can feel like more than half the feed. More fake than real.

![a screenshot of slop on pinterest](https://images.alephic.com/alephic-com/pinterest-slop.png)

As the Guardian says “[one man’s shrimp Jesus is another man’s side hustle](https://www.theguardian.com/technology/2025/dec/27/from-shrimp-jesus-to-erotic-tractors-how-viral-ai-slop-took-over-the-internet)”. And have you looked at LinkedIn / X / Substack lately? [Pangram scores](https://www.usermag.co/p/how-much-of-substack-is-actually-ai-pangram-analysis-substack-bestsellers) are being thrown around like red cards.

It’s slop as far as the eye can scroll.

(Worth noting that we are under-appreciating the flip side of this equation - explosion in creativity that is just around the corner as everyone has AI creative capabilities in their pocket. [Knicks memes](https://x.com/techhalla/status/2059545429893586955) and [animated pigeons](https://x.com/Markoslavnic/status/2052797538885902418).)
...
I think the advent of Claude Code and Codex was a bigger deal than the original ChatGPT 3.5 moment. AI usage has absolutely exploded because of these agentic tools. In May this year Cloudflare said it’s own [internal usage of AI has increased by more than 600% in the last three months alone](https://blog.cloudflare.com/building-for-the-future/) and [Coinbase has seen token usage explode in just the last few weeks.](https://x.com/brian_armstrong/status/2070670644577280109)

But the agentic revolution (Claude Code / Codex) outside of engineering teams is…. Maybe 2 months old at best??

[Codex usage outside of engineering teams has just exploded, but only in May/June 2026](https://x.com/daveholtz/status/2070147557314175072):

![a graphic showing codex adoption over time](https://images.alephic.com/alephic-com/codex-growth-usage.png)
...
For marketing teams in particular, 2026 has seen a Cambrian explosion in image and video capabilities, with SeedDance, OpenAI image models, Gemini, and so much more. Personally I’ve been enjoying generating, editing and producing video…. All in code? [You can just ask an LLM to manipulate video files now](https://thariqs.github.io/cc-video-editing-deck/). (see also [hyperframes](https://hyperframes.heygen.com/)).

On the one hand the bar for creative output has never been higher, on the other hand you’re surrounded by [slop cannons](https://x.com/danhockenmaier/status/2021617680525172840). Every knowledge worker is inundated by sloppy output and being asked to do more than ever - their old job, learn new AI tools and handle their coworkers 10x-ing their output.
...
Organizations exist to solve coordination problems. [Coase’s theory of the firm](https://interconnected.org/home/2014/12/23/corporations) says markets are powerful, but using them is not free. You have to find people, negotiate, contract, monitor, remember, enforce, and decide. Firms exist because some work is easier to coordinate inside an organization than outside in the market.
...
The clock of coordination is the rhythm and rituals of sharing status (see: [WTFS](https://www.linkedin.com/feed/update/urn:li:activity:7477402657674907648/)). Every organization runs on daily standups, weekly status reviews, monthly business reviews, quarterly board meetings and annual offsites.
...
If we accept the premise that your [organization is going to be agentic](https://tomcritchlow.com/2026/06/08/termites-tokens/) - it’s going to be a mixture of agents and humans coordinating work there’s two ideas that become practical:
...
In my piece [Of Termites & Tokens](https://tomcritchlow.com/2026/06/08/termites-tokens/) I argue that as the throughput of work increases you need to enable coordination through traces left in the environment.
...
The year is 1889, the same year that Poincaré won the prize for his work on the three body problem, [a tire company called Michelin was founded](https://guide.michelin.com/th/en/history-of-the-michelin-guide-th):
...
![an image of the original michelin guide](https://images.alephic.com/alephic-com/michelin-guide.png)
...
- What if a brand like Etsy built tools, education and almanacs on how to use ChatGPT for searching the vast Etsy library? (after all, [Shopify’s catalog API is already allowing AI agents to search across all Shopify stores](https://x.com/harleyf/status/2072748693384741155))
...
Let’s return to Paris in 1889, the Exposition Universelle but this time at night. It’s the first world’s fair to stay open at night because of the invention of electricity. Thomas Edison was a big feature at the fair and [illuminated fountains](https://www.gilwro.fr/19eSiecle/les-fontaines-lumineuses/) with colored electric light captured the imagination of the people with a spectacle never seen before.
...
![an illustration of illuminated fountains at the 1889 paris worlds fair](https://images.alephic.com/alephic-com/illuminated-fountains.png)

Meanwhile, just a few years before in 1882, [Scientific American Supplement published an essay on electro-mania](https://www.gutenberg.org/cache/epub/8717/pg8717.html.utf8) where W. Mattieu Williams argued for the separation from hype and reality around electricity - highlighting the mania of electricity making dead frogs move and people believing in re-animation.

Fast forward to 2026 and the essay by Nikhil Suresh: [AI Mania Is Eviscerating Global Decision-Making](https://hermit-tech.com/blog/ai-mania-is-eviscerating-global-decisionmaking) feels eerily similar. I agree with Nikhil’s headline, that AI-mania is eviscerating decision making, but not the conclusion that all is lost. Chaos is all around, but we must learn to act regardless. New technologies always come with a breathless mania - our task (perhaps the uniquely human task?) is to separate the spectacle from the sublime. To discern between being tasked with animating dead frogs and illuminating dancing fountains.
